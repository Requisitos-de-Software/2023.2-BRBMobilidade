...
O propósito deste documento é esclarecer de maneira transparente a rastreabilidade de todos os requisitos identificados ao longo do desenvolvimento do projeto. Para isso, os requisitos serão associados aos métodos específicos de obtenção e modelagem, seguindo a abordagem de rastreabilidade Backward From.

## **Objetivo**

Este documento tem como objetivo principal estabelecer de maneira clara e sistemática a conexão entre os requisitos identificados no decorrer do projeto e os métodos de elicitação e modelagem utilizados. Utilizando a abordagem de rastreabilidade Backward From, buscamos traçar uma linha transparente que vincule cada requisito aos seus métodos correspondentes, proporcionando uma compreensão abrangente da origem e do processo de desenvolvimento de cada componente essencial do projeto.

## **Metodologia**

Os requisitos funcionais e não funcionais previamente [Elicitados](https://requisitos-de-software.github.io/2023.2-BRBMobilidade/Elicitação/priorização%20de%20requisitos/Three%20Level%20Scale/) foram estruturados para criar a tabela a seguir. Nesse processo, verificou-se a conexão entre os requisitos e os artefatos associados a cada um, garantindo uma análise abrangente dos vínculos existentes.
...
Satisfaz RF12 (Consulta de Extrato): Este requisito satisfaz a necessidade de consultar o extrato, como descrito no RF12.
...
Agrega RF06 (Integração com Navegação e Mapas): A funcionalidade de acessar itinerários detalhados agrega a capacidade de integração com navegação e mapas, permitindo otimizar rotas e facilitar a localização de paradas de ônibus.
...
Agrega RF14 (Recarga do Saldo): A funcionalidade de realizar recargas de créditos agrega a capacidade específica de recarregar o saldo do cartão.
...
Agrega RF27 (Concede Visualização a Quantidade de Passes): A funcionalidade de interagir com um chatbot agrega a capacidade específica de conceder visualização à quantidade de passes.
...
Agrega RF26 (Concede Acesso às Paradas Próximas): A funcionalidade de integrar funcionalidades de navegação e mapas agrega a capacidade específica de conceder acesso às paradas próximas.
...
Agrega RF28 (Pagamento via Cartão de Crédito): A funcionalidade de cadastrar métodos de pagamento agrega a opção específica de pagamento via cartão de crédito.
...
Agrega RF17 (Fornece uma Seção de Comunicação Direta): A funcionalidade de personalizar a aparência da interface do usuário agrega a capacidade específica de fornecer uma seção de comunicação direta.
...
Agrega RF16 (Alterar Informações de Cadastro): A funcionalidade de realizar cadastro agrega a capacidade específica de alterar informações de cadastro.
...
Satisfaz BS14 (Brainstorming sobre Recuperação de Senha): Este elo estabelece que o requisito atende às ideias provenientes do brainstorming sobre a recuperação de senha.
...
Agrega RF01 (Consulta de Saldo e Extrato): A funcionalidade de consultar o extrato agrega a capacidade específica de consultar o saldo, proporcionando aos usuários detalhes sobre o uso do cartão de mobilidade.
...
Agrega BS06 (Brainstorming sobre Integração com Navegação e Mapas): A funcionalidade de integrar navegação e mapas agrega a capacidade específica de mostrar pontos de recarga, proporcionando aos usuários informações detalhadas sobre a localização desses pontos.
...
Satisfaz BS17 (Brainstorming sobre Bloqueio/Cancelamento do Cartão): Este elo estabelece que o requisito atende às ideias provenientes do brainstorming sobre o bloqueio/cancelamento do cartão.
...
Agrega RF19 (Acessar Informações sobre o Histórico de Atividades): A funcionalidade de fornecer ajuda com perguntas frequentes agrega a capacidade específica de acessar informações sobre o histórico de atividades.
...
Agrega RF20 (Solicitar uma 2ª Via do Cartão Desejado): A funcionalidade de acessar informações sobre o histórico de atividades agrega a capacidade específica de solicitar uma 2ª via do cartão desejado.
...
Agrega RF21 (Fornecer Ajuda com Perguntas Frequentes): A funcionalidade de solicitar uma 2ª via do cartão desejado agrega a capacidade específica de fornecer ajuda com perguntas frequentes.
...
Agrega RF25 (Mecanismo de Desbloqueio de Cartões): A funcionalidade de mecanismo de bloqueio de cartões agrega a capacidade específica de mecanismo de desbloqueio de cartões.
...
Agrega RF21 (Fornecer Ajuda com Perguntas Frequentes): A funcionalidade de fornecer notificações de depósito ao usuário agrega a capacidade específica de fornecer ajuda com perguntas frequentes.
